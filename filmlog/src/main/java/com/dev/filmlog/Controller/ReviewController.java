...
public class ReviewController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addReview(@AuthenticationPrincipal User user, @Valid @RequestBody ReviewDTOIn reviewDTOIn) {
    ...
    public ResponseEntity<?> updateReview(@AuthenticationPrincipal User user, @PathVariable Integer reviewId,@Valid @RequestBody ReviewDTOIn reviewDTOIn) {
