...
public class MediaController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addMedia(@AuthenticationPrincipal User user,@RequestBody Media media) {
    ...
    public ResponseEntity<?> updateMedia(@AuthenticationPrincipal User user,@PathVariable Integer mediaId, @RequestBody Media media) {
