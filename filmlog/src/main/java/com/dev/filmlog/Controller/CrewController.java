...
public class CrewController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addCrew(@AuthenticationPrincipal User user,@Valid @RequestBody Crew crew) {
    ...
    public ResponseEntity<?> updateCrew(@AuthenticationPrincipal User user,@PathVariable Integer crewId, @Valid @RequestBody Crew crew) {
