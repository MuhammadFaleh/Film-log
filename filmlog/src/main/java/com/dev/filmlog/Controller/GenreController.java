...
public class GenreController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addGenre(@AuthenticationPrincipal User user,@RequestBody Genre genre) {
    ...
    public ResponseEntity<?> updateGenre(@AuthenticationPrincipal User user,@PathVariable Integer genreId, @RequestBody Genre genre) {
